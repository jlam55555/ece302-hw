...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			Using Bayes' rule, we can calculate the posterior pmf of $X$ given that five trolls didn't survive.
			\begin{equation*}
				P(X=x|\text{five died})=\frac{P((X=x)\land(\text{the other five died}))}{P(\text{the other five died})}
			\end{equation*}
			This in turn can be used to calculate the expected hp of the surviving troll:
			\begin{gather*}
				E[X|\text{the other five died}]=(3)P((\text{iii}))+(4)P((\text{i})+(\text{ii}))\\
				=3\left(\frac{1}{4}\right)\left(\frac{1}{4}\right)\left(\frac{1}{2}\right)^5+4\left[\left(\frac{1}{4}\right)+\left(\frac{1}{2}\right)\left(\frac{3}{4}\right)^5+\left(\frac{1}{4}\right)\left(\frac{1}{4}\right)\left(\frac{1}{2}\right)^5\right]
			\end{gather*}
